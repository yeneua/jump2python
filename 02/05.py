...
## key 값은 변하지 않는(immutable) 값만 가능 : 정수, 실수, 문자열, 튜플 가능 / 리스트, 딕셔너리, 집합 불가
...
print(a.get('notfound', '값이 없습니다')) # get(x,'디폴트 값') : 존재하지 않는 key일 경우 디폴트 값을 대신 가져오게 함
